...
function Footer() {
  return (
    <div className="py-[5vw] w-full flex px-[4vw]">

        <div className="w-1/2">
          <div className="flex flex-col gap-[25vw]">
            <h1 className="font-[grotesk] text-[10vw] leading-[8vw]">EYE- <br />OPENING</h1>
            <svg
              width="72"
              height="30"
              viewBox="0 0 72 30"
        ...
        <div className="w-1/2 flex flex-col gap-[2vw]">
          <h1 className="font-[grotesk] text-[10vw]">PRESENTATION</h1>

          <div>
            <h1>S:</h1>
            <ul className="mt-[0.5vw]">
              {["Instagram","Behance","Facebook","Linkedin"].map(item => 
              <li>
                <a href="" className="mb-[0.2vw] border-b border-[#212121]">
                  {item}
                </a>
              </li>)}
            </ul>
          ...
          <div className="flex justify-between">
            ...
            <h1>L:</h1>
            <span>202-1965 W 4th Ave <br />
            Vancouver, Canada</span>
            <span>30 Chukarina St <br />
            Lviv, Ukraine</span>
            </div>
           <div>
           <h1>M:</h1>
          ...
          <div className="text-zinc-400 mt-[2vw]">
            © ochi design 2024. <span className="underline text-zinc-400">Legal Terms</span>
          </div>
